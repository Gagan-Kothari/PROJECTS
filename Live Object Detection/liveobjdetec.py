...
model_path = r"Python\Live Object Detection\MobileNetSSD_deploy.caffemodel"
prototxt_path = r"Python\Live Object Detection\MobileNetSSD_deploy.prototxt.txt"
...
while True:
    ...
    blob = cv2.dnn.blobFromImage(cv2.resize(image,(300,300)),0.007,(300,300))
